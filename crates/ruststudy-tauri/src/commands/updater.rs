...
const GITEE_API: &str = "https://gitee.com/api/v5/repos/kz_y/ruststudy/releases/latest";
...
pub async fn check_for_updates() -> Result<UpdateInfo, String> {
    ...
    let client = reqwest::Client::builder()
        .user_agent("RustStudy-Updater/1.0")
    ...
    Ok(UpdateInfo {
        ...
        release_url: release
            .html_url
            .unwrap_or_else(|| format!("https://gitee.com/kz_y/ruststudy/releases/tag/{}", release.tag_name)),
